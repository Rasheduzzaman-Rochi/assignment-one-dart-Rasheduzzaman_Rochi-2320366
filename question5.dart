...
void main() {
  ...
  final managerBaseSalary = manager.getBaseSalary();
  print("Base Salary: $managerBaseSalary");
  final managerSalary = manager.calculateSalary(managerBaseSalary, 1000.0);
  ...
  final devBaseSalary = developer.getBaseSalary();
  print("Base Salary: $devBaseSalary");
  final devSalary = developer.calculateSalary(devBaseSalary, 500.0);
